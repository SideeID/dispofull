...
Route::middleware(['auth:sanctum', 'verified', 'role:rektorat'])->group(function () {
    ...
    // API JSON untuk Surat Masuk (dinamis)
    Route::prefix('rektor/api')->name('rektor.api.')->group(function(){
...
Route::middleware(['auth:sanctum', 'verified', 'role:unit_kerja'])->group(function () {
    ...
    Route::prefix('unit-kerja/api')->name('unit_kerja.api.')->group(function(){
        ...
        // temporary attachments upload (used by modal Lampiran)
        ...
        // one-shot submit directly from form (create draft, attach files, then submit)
