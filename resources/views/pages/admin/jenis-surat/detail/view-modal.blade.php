	...
	<div class="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4 py-6 sm:p-0">
		...
		<div class="relative w-full sm:max-w-lg bg-white dark:bg-gray-800 rounded-2xl shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 p-6 flex flex-col gap-5">
			<div class="flex items-start justify-between gap-4">
				<div>
					<h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Detail Jenis Surat</h3>
					<p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Informasi lengkap jenis surat.</p>
				</div>
			...
			<div class="text-sm space-y-4 max-h-[55vh] overflow-y-auto pr-2">
				<div class="grid grid-cols-3 gap-3">
					...
					<div class="text-gray-500 dark:text-gray-400 text-xs">Kategori</div>
					<div class="col-span-2"><span x-text="selected?.category" class="px-2 py-0.5 rounded-full text-[11px] font-medium bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300"></span></div>
					...
					<div class="text-gray-500 dark:text-gray-400 text-xs">Format Nomor</div>
					<div class="col-span-2 font-mono text-[11px] break-all text-gray-700 dark:text-gray-200" x-text="selected?.format"></div>
					<div class="text-gray-500 dark:text-gray-400 text-xs">Digunakan</div>
					<div class="col-span-2 font-medium" x-text="selected?.used"></div>
					<div class="text-gray-500 dark:text-gray-400 text-xs">Deskripsi</div>
					<div class="col-span-2 text-gray-700 dark:text-gray-300" x-text="selected?.description || '-' "></div>
				</div>
			</div>
