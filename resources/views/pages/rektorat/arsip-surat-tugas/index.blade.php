<x-app-layout>
	<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-7xl mx-auto"
		 x-data="{
			showView:false, showHistory:false, showParticipants:false, showAttachment:false, showRestore:false, showExport:false,
			selected:null,
			open(modal,row=null){ this.selected=row; this[modal]=true },
			closeAll(){ this.showView=false; this.showHistory=false; this.showParticipants=false; this.showAttachment=false; this.showRestore=false; this.showExport=false; },
		}"
	...
	>
		...
		<div class="bg-white dark:bg-gray-800 rounded-lg ring-1 ring-gray-200 dark:ring-gray-700">
						...
						<tr class="hover:bg-gray-50/60 dark:hover:bg-gray-700/40" x-data="{ row: @js($a) }">
							...
							<td class="px-5 py-3 text-right align-top">
								<div class="flex items-center justify-end gap-1">
									...
									<button @click="open('showRestore', row)" class="p-1.5 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-600/20 text-emerald-600 dark:text-emerald-400" title="Pulihkan"><i data-feather='corner-up-left' class='w-4 h-4'></i></button>
								</div>
							</td>
						</tr>
						@endforeach
			...
			<div class="px-5 py-4 border-t border-gray-100 dark:border-gray-700/60 flex items-center justify-between text-[11px] text-gray-500 dark:text-gray-400">
				...
				<div class="flex gap-1">
					...
					<button class="px-2 py-1 rounded bg-slate-700 text-white">1</button>
		...
		@include('pages.rektorat.arsip-surat-tugas.detail.view-modal')
		@include('pages.rektorat.arsip-surat-tugas.detail.participants-modal')
		@include('pages.rektorat.arsip-surat-tugas.detail.attachment-modal')
		@include('pages.rektorat.arsip-surat-tugas.detail.history-modal')
		@include('pages.rektorat.arsip-surat-tugas.detail.restore-modal')
		@include('pages.rektorat.arsip-surat-tugas.detail.export-modal')
