	...
	<div class="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4 py-6 sm:p-0">
		...
		<div class="relative w-full sm:max-w-xl bg-white dark:bg-gray-800 rounded-2xl shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 p-6 flex flex-col gap-5">
			<div class="flex items-start justify-between gap-4">
				<div>
					<h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Riwayat Surat Tugas (Arsip)</h3>
			...
			<div class="max-h-[55vh] overflow-y-auto pr-1 text-sm">
				<ul class="space-y-4" x-data="{ logs: [] }" x-init="logs = [
					{time:'2025-10-02 10:30',actor:'Sistem',action:'Diarsipkan',status:'success'},
					{time:'2025-09-25 09:05',actor:'Sekretariat',action:'Laporan kegiatan diterima',status:'info'},
					{time:'2025-09-19 16:10',actor:'Sekretariat',action:'Kegiatan selesai',status:'info'},
					{time:'2025-09-15 08:00',actor:'Rektor',action:'Menandatangani surat',status:'success'},
					{time:'2025-09-14 17:12',actor:'Sekretariat',action:'Menambah peserta',status:'info'},
					{time:'2025-09-14 16:40',actor:'Sekretariat',action:'Membuat draft',status:'success'},
				]">
