					...
					<div class="grid grid-cols-2 gap-4">
						...
						<div>
							...
							<div><span class="px-2 py-0.5 rounded-full text-[11px] font-medium" :class="{
								...
								'bg-amber-500/10 text-amber-600 dark:text-amber-400': selected?.status=='need_signature',
				...
				<div class="space-y-5">
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
						...
						<ul class="space-y-2 text-xs text-gray-600 dark:text-gray-300">
							...
							<li><button @click="closeAll(); open('showParticipants', selected)" class="text-amber-600 dark:text-amber-400 hover:underline">Kelola &raquo;</button></li>
						</ul>
					</div>
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
					...
					<div class="flex gap-2" x-show="['draft','need_signature'].includes(selected?.status)">
