				...
				<div class="space-y-4">
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4 h-full">
						...
						<ul class="space-y-2 text-xs text-gray-600 dark:text-gray-300 max-h-56 overflow-y-auto pr-1">
							<li class="flex items-center justify-between gap-2"><span>Nama A · Ketua</span><button class="text-rose-500 hover:underline">Hapus</button></li>
							<li class="flex items-center justify-between gap-2"><span>Nama B · Anggota</span><button class="text-rose-500 hover:underline">Hapus</button></li>
							<li class="flex items-center justify-between gap-2"><span>Nama C · Anggota</span><button class="text-rose-500 hover:underline">Hapus</button></li>
							<li class="flex items-center justify-between gap-2"><span>Nama D · Anggota</span><button class="text-rose-500 hover:underline">Hapus</button></li>
						</ul>
					</div>
				</div>
				<div class="space-y-5">
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
						...
						<form class="space-y-4" @submit.prevent="alert('Tambah peserta (dummy)')">
							<div>
								...
								<input type="text" class="w-full rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500" placeholder="Nama Peserta" />
							</div>
							<div class="grid grid-cols-2 gap-4">
								<div>
									<label class="block text-[11px] font-medium mb-1 text-gray-600 dark:text-gray-300">Peran</label>
									<select class="w-full rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-2 py-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500">
								...
								<div>
									...
									<input type="text" class="w-full rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500" placeholder="Unit" />
								</div>
							</div>
							<div class="flex items-center justify-end">
								<button type="submit" class="px-4 py-2 rounded-lg text-xs bg-indigo-600 hover:bg-indigo-500 text-white font-medium">Tambah</button>
							</div>
						</form>
					</div>
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
						...
						<ul class="space-y-2 text-xs text-gray-600 dark:text-gray-300 max-h-28 overflow-y-auto pr-1">
							<li>2025-10-02 11:10 · Menambah Nama D</li>
							<li>2025-10-02 10:40 · Menghapus Nama X</li>
						</ul>
					</div>
				</div>
			</div>
