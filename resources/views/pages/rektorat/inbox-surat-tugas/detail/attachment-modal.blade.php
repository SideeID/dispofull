				...
				<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
					...
					<ul class="space-y-2 text-xs text-gray-600 dark:text-gray-300 max-h-60 overflow-y-auto pr-1">
						<li class="flex items-center justify-between gap-3 p-2 rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600">
							<div class="flex items-center gap-2"><i data-feather="file" class="w-3.5 h-3.5 text-indigo-500"></i><span>tor_kegiatan.pdf</span></div>
							<div class="flex items-center gap-1">
								<button class="text-indigo-600 dark:text-indigo-400 hover:underline text-[11px]">Lihat</button>
								<button class="text-rose-500 hover:underline text-[11px]">Hapus</button>
							</div>
						</li>
						<li class="flex items-center justify-between gap-3 p-2 rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600">
							<div class="flex items-center gap-2"><i data-feather="file" class="w-3.5 h-3.5 text-indigo-500"></i><span>rundown.docx</span></div>
							<div class="flex items-center gap-1">
								<button class="text-indigo-600 dark:text-indigo-400 hover:underline text-[11px]">Lihat</button>
								<button class="text-rose-500 hover:underline text-[11px]">Hapus</button>
							</div>
				...
				<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
					...
					<form class="space-y-3" @submit.prevent="alert('Upload lampiran (dummy)')">
						...
						<div class="flex items-center justify-end">
							<button type="submit" class="px-4 py-2 rounded-lg text-xs bg-indigo-600 hover:bg-indigo-500 text-white font-medium">Upload</button>
						</div>
					</form>
				</div>
			</div>
