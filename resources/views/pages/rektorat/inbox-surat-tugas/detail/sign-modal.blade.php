		...
		<div class="relative w-full sm:max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 p-6 flex flex-col gap-5">
			...
			<div class="space-y-4 text-sm">
				<div class="bg-gray-50 dark:bg-gray-700/40 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center">
					<p class="text-xs text-gray-500 dark:text-gray-400 mb-3">Area tanda tangan (placeholder). Integrasikan komponen / service tanda tangan.</p>
				...
				<div>
					...
					<textarea rows="3" class="w-full rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500 text-gray-700 dark:text-gray-100" placeholder="Catatan tanda tangan..."></textarea>
				</div>
				<div class="flex items-center justify-end gap-3 pt-2">
					...
					<button type="button" @click="alert('Tanda tangan surat tugas (dummy)'); closeAll()" class="px-4 py-2 rounded-lg text-xs bg-emerald-600 hover:bg-emerald-500 text-white font-medium">Tandatangani</button>
				</div>
			</div>
		</div>
	</div>
