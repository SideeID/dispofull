			...
			<div class="space-y-4 text-sm">
				...
				<div class="flex gap-2 border-b border-gray-200 dark:border-gray-700">
					<button type="button" @click="signMode = 'draw'" 
						:class="signMode === 'draw' ? 'border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'"
					...
					<button type="button" @click="signMode = 'upload'" 
						:class="signMode === 'upload' ? 'border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'text-gray-500 dark:text-gray-400'"
						class="px-4 py-2 text-xs font-medium">
				...
				<div x-show="signMode === 'upload'"
					...
					<div class="space-y-3">
						<button type="button" @click="$refs.signatureFile.click()"
							class="w-full px-4 py-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-indigo-500 transition-colors">
				...
				<div class="grid grid-cols-2 gap-4">
					<div>
						...
						<select x-model="form.signature_type" class="w-full rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-2 py-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500">
					...
					<div>
						...
						<select class="w-full rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-2 py-1.5 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500">
				...
				<div>
					...
					<textarea rows="3" x-model="form.notes" class="w-full rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:focus:ring-indigo-500 text-gray-700 dark:text-gray-100" placeholder="Catatan tanda tangan..."></textarea>
				</div>
