			...
			<div class="grid md:grid-cols-2 gap-6 text-sm">
				<div class="space-y-3">
					...
					<div>
						...
						<p class="text-gray-600 dark:text-gray-300 mt-1 leading-relaxed">Contoh ringkasan isi surat (placeholder) - integrasikan dengan field konten ringkas surat ketika data tersedia.</p>
					</div>
				</div>
				<div class="space-y-5">
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
						...
						<ul class="space-y-2 text-xs text-gray-600 dark:text-gray-300">
							<li class="flex items-center justify-between"><span>proposal_kerjasama.pdf</span><button class="text-amber-600 dark:text-amber-400 hover:underline">Unduh</button></li>
							<li class="flex items-center justify-between"><span>profil_mitra.pdf</span><button class="text-amber-600 dark:text-amber-400 hover:underline">Unduh</button></li>
						</ul>
					</div>
					<div class="bg-gray-50 dark:bg-gray-700/40 rounded-lg p-4">
						<div class="text-[11px] uppercase font-semibold tracking-wide text-gray-400 dark:text-gray-500 mb-2">Aktivitas Terakhir</div>
						<ul class="space-y-2 text-xs text-gray-600 dark:text-gray-300">
							<li>2025-10-02 09:21 · Disposisi dibuat ke WR I</li>
							<li>2025-10-02 08:55 · Lampiran ditambahkan</li>
							<li>2025-10-01 16:10 · Surat diterima</li>
						</ul>
					</div>
					<div class="flex gap-2">
						<button @click="closeAll(); open('showDisposition', selected)" class="flex-1 px-4 py-2 rounded-lg text-xs bg-amber-600 hover:bg-amber-500 text-white font-medium">Disposisi</button>
