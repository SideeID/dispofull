		...
		<div class="relative w-full sm:max-w-xl bg-white dark:bg-gray-800 rounded-2xl shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 p-6 flex flex-col gap-5">
			...
			<div class="max-h-[55vh] overflow-y-auto pr-1 text-sm">
				<ul class="space-y-4" x-data="{ logs: [] }" x-init="logs = [
					{time:'2025-10-02 09:21',actor:'Rektor',action:'Membuat disposisi ke WR I',status:'success'},
					{time:'2025-10-02 08:55',actor:'Sekretariat',action:'Menambahkan lampiran proposal_kerjasama.pdf',status:'info'},
					{time:'2025-10-01 16:10',actor:'Sekretariat',action:'Menandai surat sebagai diterima',status:'success'},
				]">
