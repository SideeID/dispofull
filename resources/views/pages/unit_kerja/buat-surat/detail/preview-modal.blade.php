<template x-if="openFlags.showPreview">
            ...
            <div class="overflow-y-auto px-8 py-8 text-sm leading-relaxed bg-gray-50 dark:bg-gray-800/40 flex-1">
                <div class="max-w-3xl mx-auto space-y-8">
                    ...
                    <div class="text-center space-y-1">
                        <div class="letter-title" x-text="form.perihal || 'Judul / Perihal Surat' "></div>
                          <div class="letter-number">
							<span>Nomor :</span>
							<span x-text="computedNumber()"></span>
						</div>
                    </div>
                    
                    <!-- Konten surat -->
                    <div class="content prose prose-sm dark:prose-invert max-w-none" x-html="(form.konten||'') || '<p><em>Konten surat belum diisi.</em></p>'"></div>
                    
                    <!-- Tanda tangan -->
                    <div class="signature">
                        <p>Jakarta, <span x-text="form.tanggal || '—'"></span></p>
                        <br><br><br><br>
                        <p x-text="signer ? signer.nama : '[Nama Penandatangan]'"></p>
                        <p x-text="signer ? signer.jabatan : '[Jabatan Penandatangan]'"></p>
                    </div>
