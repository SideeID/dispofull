		...
		<div class="relative w-full sm:max-w-xl bg-white dark:bg-gray-800 rounded-2xl shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 p-6 flex flex-col gap-5">
			...
			<div class="max-h-[55vh] overflow-y-auto pr-1 text-sm">
				<ul class="space-y-4" x-data="{ logs: [] }" x-init="logs = [
					...
					{time:'2025-09-30 14:12',actor:'Sekretariat',action:'Laporan diterima',status:'info'},
					{time:'2025-09-18 16:10',actor:'Sekretariat',action:'Kegiatan selesai',status:'info'},
					{time:'2025-09-16 08:00',actor:'BAA',action:'Menandatangani surat',status:'success'},
					{time:'2025-09-15 17:12',actor:'Sekretariat',action:'Menambah peserta',status:'info'},
					{time:'2025-09-15 16:40',actor:'Sekretariat',action:'Membuat draft',status:'success'},
				]">
