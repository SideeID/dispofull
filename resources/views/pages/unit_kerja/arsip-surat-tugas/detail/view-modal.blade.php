			...
			<div class="grid md:grid-cols-2 gap-6 text-sm">
				...
				<div class="space-y-5">
					...
					<div class="flex gap-2">
						<button @click="closeAll(); open('showHistory', selected)" class="flex-1 px-4 py-2 rounded-lg text-xs bg-amber-600 hover:bg-amber-500 text-white font-medium">Riwayat Lengkap</button>
					</div>
				</div>
			</div>
